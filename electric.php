...
<head>
  ...
  <link rel="stylesheet" href="main/electic.css">
  <link rel="stylesheet" href="test.css">

  <title>Ремонт автоэлектрики</title>
</head>
<body>
  <header>
    <div class="shapka">
...
<div class="main section">
  <div class="content">
      ...
      <h1>Диагностика и ремонт автоэлектрики в&nbsp;Автосервисе <span>MAMGUK</span> в Пыскоре</h1>
        <ul>
          <li>Компьютерная диагностика от 800 руб</li>
          <li>Считываение и сканирование кодов ошибок</li>
          <li>Современное оборудование</li>
          <li>Соблюдаем сроки по договору</li>
...
<section>
  <div id="techob" class="uslugi">
    ...
    <div class="uslugi1">
      <h2>Основные услуги по ремонту автоэлектрики</h2>
    </div>
    <div class="karts">
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Диагностика автоэлектрики" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/electric/item1.png" alt="Диагностика автоэлектрики">
        </div>
        <p class="services__caption">Диагностика автоэлектрики</p>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Компьютерная диагностика" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/electric/item2.png" alt="Компьютерная диагностика">
        </div>
        <p class="services__caption">Компьютерная диагностика</p>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Диагностика и ремонт генератора" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/electric/item3.png" alt="Диагностика и ремонт генератора">
      </div>
      <div class="services__caption">Диагностика и ремонт генератора</div>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Замена блока предохранителей" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/electric/item4.png" alt="Замена блока предохранителей">
      </div>
      <div class="services__caption">Замена блока предохранителей</div>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Замена аккумулятора" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/electric/item5.png" alt="Замена аккумулятора">
      </div>
      <div class="services__caption">Замена аккумулятора</div>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Диагностика и ремонт стартера" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/electric/item6.png" alt="Диагностика и ремонт стартера">
      </div>
      <div class="services__caption">Диагностика и ремонт стартера</div>
      </a>

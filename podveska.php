...
<head>
  ...
  <link rel="stylesheet" href="main/podveska.css">
  <link rel="stylesheet" href="test.css">

  <title>Ремонт подвески</title>
</head>
<body>
  <header>
    <div class="shapka">
...
<div class="main section">
  <div class="content">
      <div class="main__wrapper _obs">
        <h1>Диагностика и&nbsp;ремонт подвески в&nbsp;Автосервисе <span>MAMGUK</span> в Пыскоре</h1>
          <ul>
            <li>Современное оборудование</li>
            <li>Запчасти в наличии и под заказ</li>
...
<section>
  <div id="techob" class="uslugi">
    ...
    <div class="uslugi1">
      <h2>Основные услуги по ремонту подвески</h2>
    </div>
    <div class="karts">
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Замена рычагов подвески" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/podveska/item1.png" alt="Замена рычагов подвески">
        </div>
        <p class="services__caption">Замена рычагов подвески</p>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Замена сайлентблоков" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/podveska/item2.png" alt="Замена сайлентблоков">
        </div>
        <p class="services__caption">Замена сайлентблоков</p>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Замена поворотного кулака" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/podveska/item3.png" alt="Замена поворотного кулака">
      </div>
      <div class="services__caption">Замена поворотного кулака</div>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Замена пружин" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/podveska/item4.png" alt="Замена пружин">
      </div>
      <div class="services__caption">Замена пружин</div>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Замена передней ступицы колеса" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/podveska/item5.png" alt="Замена передней ступицы колеса">
      </div>
      <div class="services__caption">Замена передней ступицы колеса</div>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Замена заднего нижнего рычага" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/podveska/item6.png" alt="Замена заднего нижнего рычага">
      </div>
      <div class="services__caption">Замена заднего нижнего рычага</div>
      </a>

...
<head>
  ...
  <link rel="stylesheet" href="main/kondey.css">
  <link rel="stylesheet" href="test.css">

  <title>Ремонт автокондиционеров</title>
</head>
...
<div class="main section">
  <div class="content">
      <div class="main__wrapper _obs">
        <h1>Диагностика, ремонт и заправка кондиционеров в Автосервисе <span>MAMGUK</span> в Пыскоре</h1>
          <ul>
            <li>Выполняем в кратчайшие сроки</li>
            <li>Прием на сервис без очередей</li>
            <li>Запчасти в наличии</li>
            <li>Опыт мастеров более 10 лет</li>
          </ul>
...
<section>
  <div id="techob" class="uslugi">
    ...
    <div class="uslugi1">
      <h2>Основные услуги по ремонту автокондиционеров</h2>
    </div>
    <div class="karts">

      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Диагностика автокондиционера" onclick="sendLabel(this.getAttribute('data-label'))"> 
        <div class="carta-img">
          <img src="main/img/kondey/diagnostika.png" alt="Диагностика автокондиционера">
        </div>
        <p class="services__caption" >Диагностика автокондиционера</p>
      </a>
      
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Ремонт трубок кондиционера" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/kondey/trubki.png" alt="Ремонт трубок кондиционера">
        </div>
        <p class="services__caption" >Ремонт трубок кондиционера</p>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Установка предпусковых подогреваталей" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/kondey/podogrev.png" alt="Установка предпусковых подогреваталей">
      </div>
      <div class="services__caption" >Установка предпусковых подогреваталей</div>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Заправка автокондиционера" onclick="sendLabel(this.getAttribute('data-label'))"> 
        <div class="carta-img">
          <img src="main/img/kondey/zapravka.png" alt="Заправка автокондиционера">
      </div>
      <div class="services__caption">Заправка автокондиционера</div>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Мойка радиатора кондиционера" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/kondey/moika.png" alt="Мойка радиатора кондиционера">
      </div>
      <div class="services__caption">Мойка радиатора кондиционера</div>
      </a>

      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Замена салонного фильтра" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/kondey/filtr.png" alt="Замена салонного фильтра">
      </div>
      <div class="services__caption">Замена салонного фильтра</div>
      </a>

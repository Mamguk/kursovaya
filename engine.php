...
<head>
  ...
  <link rel="stylesheet" href="main/engine.css">
        ...
        <ul class="list">
          ...
          <div class="contacts">
            ...
            <div class="contacts-phone">
              <a href="tel:+79194994329">+7 919 499-43-29</a><br>
...
<div class="main section">
  <div class="content">
      <div class="main__wrapper _obs">
        <h1>Ремонт двигателей в&nbsp;Автосервисе <span>MAMGUK</span> в Пыскоре</h1>
          <ul>
...
<section>
  <div id="techob" class="uslugi">
    ...
    <div class="uslugi1">
      <h2>Основные услуги по ремонту двигателя</h2>
    </div>
    <div class="karts">
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Снятие или установка двигателя" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/engine/item1.png" alt="Снятие или установка двигателя">
        </div>
        <p class="services__caption">Снятие или установка двигателя</p>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Замена ремня генератора" onclick="sendLabel(this.getAttribute('data-label'))"> 
        <div class="carta-img">
          <img src="main/img/engine/item2.png" alt="Замена ремня генератора">
        </div>
        <p class="services__caption">Замена ремня генератора</p>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Замена впускного коллектора" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/engine/item3.png" alt="Замена впускного коллектора">
      </div>
      <div class="services__caption">Замена впускного коллектора</div>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Замена ремня ГУР" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/engine/item4.png" alt="Замена ремня ГУР">
      </div>
      <div class="services__caption">Замена ремня ГУР</div>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Замена распредвала" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/engine/item5.png" alt="Замена распредвала">
      </div>
      <div class="services__caption">Замена распредвала</div>
      </a>
      <a class="carta" data-bs-toggle="modal" data-bs-target="#exampleModal" data-label="Замена свечей зажигания" onclick="sendLabel(this.getAttribute('data-label'))">
        <div class="carta-img">
          <img src="main/img/engine/item6.png" alt="Замена свечей зажигания">
      </div>
      <div class="services__caption">Замена свечей зажигания</div>
      </a>
